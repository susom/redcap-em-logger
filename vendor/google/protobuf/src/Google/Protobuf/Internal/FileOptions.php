...
class FileOptions extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>optional .google.protobuf.FileOptions.OptimizeMode optimize_for = 9 [default
     * = SPEED];</code>
     */
     ...
     *     $uninterpreted_option The parser stores options it doesn't recognize here. See the documentation for the
