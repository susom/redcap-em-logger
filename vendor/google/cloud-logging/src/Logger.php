...
class Logger
{
     ...
     * @see https://cloud.google.com/logging/docs/api/reference/rest/v2/projects.logs/delete projects.logs delete API
     *     documentation.
     ...
     *           associated with this log entry, if applicable. Please see the
     *           [API docs](https://cloud.google.com/logging/docs/api/reference/rest/v2/LogEntry#httprequest)
     ...
     * @type bool $traceSampled True means that the trace resource name in
     *           the trace field was sampled for storage in a trace backend.
